...
def explorer_page(df_explorer):
    ...
    # Weitere Filter... (Tanzbarkeit, Popularität, Tempo)
    # Diese Filter sind identisch zum Originalcode und werden hier der Kürze halber nicht wiederholt
    # Der Code funktioniert aber, wenn er hier eingefügt wird.
